...
<h1 style="text-align: center;color: green">Enrol New Session</h1>
  <div class="panel-body">
			<form role="form" class="form-horizontal" action="{{route('session.store')}}">
							...
							<div class="col-md-8">
								<div class="input-group input-icon right">
									...
									<input id="name" name="name" required="true" class="form-control1" type="text" placeholder="session name">
								</div>
							</div>
...
<div style="background-color: white">
<h2 style="text-align: center;"> All Session</h2>
...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="{{route('delete.session',$cls->id)}}" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-remove"></i> Delete</a>
                <a href="{{route('session.create')}}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-plus"></i> Add Section</a>
           </td>
...
<script type="text/javascript" src="{{asset('js/Session/update.js')}}"></script>
<script type="text/javascript">
var token='{{Session::token()}}';
var add='{{route('edit.session')}}';
