...
<h1 style="text-align: center;color: green">Enter  Classes</h1>
  <div class="panel-body">
			<form role="form" class="form-horizontal" action="{{route('class.store')}}">
							...
							<div class="col-md-8">
								<div class="input-group input-icon right">
									...
									<input required="true" id="name" name="name" class="form-control1" type="text" placeholder="class name">
								</div>
							</div>
...
<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <a href="{{route('class.create')}}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-plus"></i> Add Class</a>
...
<script type="text/javascript" src="{{asset('js/Class/class.js')}}"></script>
<script type="text/javascript">
var token='{{Session::token()}}';
var add='{{route('edit.schoolclass')}}';
